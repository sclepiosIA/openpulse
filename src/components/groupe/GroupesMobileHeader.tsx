...
interface GroupesMobileHeaderProps {
  searchValue: string
...
export function GroupesMobileHeader({
  searchValue,
  onSearchChange,
  onCreateClick,
  stats,
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10 px-3 pt-3 pb-4 space-y-3">
        {/* Row 1: Hamburger, Title + Stats, Search + Create button */}
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-base font-semibold text-white truncate">Groupes</h1>
              <p className="text-[10px] text-white/60 truncate">
                {stats.displayed} affich. • {stats.total} total • {stats.ght} GHT
              </p>
            </div>
          </div>
