...
import { Building2, Search, Plus, Menu } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { useMobileDrawer } from '@/contexts/MobileDrawerContext'
import { cn } from '@/lib/utils'

interface EtablissementsMobileHeaderProps {
  searchValue: string
...
export function EtablissementsMobileHeader({
  searchValue,
  onSearchChange,
  onCreateClick,
  stats,
  toolbar,
  showGlobalNav = true,
}: EtablissementsMobileHeaderProps) {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10 px-3 pt-3 pb-4 space-y-3">
        {/* Row 1: Hamburger, Title + Stats, Create button */}
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-base font-semibold text-white truncate">Établissements</h1>
              <p className="text-[10px] text-white/60 truncate">
                {stats.displayed} affich. • {stats.total} total
              </p>
            </div>
          </div>
        ...
        {/* Row 2: Toolbar (filters, view selector, sort) */}
        {toolbar && (
