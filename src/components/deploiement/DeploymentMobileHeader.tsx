...
interface DeploymentMobileHeaderProps {
  searchValue: string
  ...
  /** Toolbar elements (view selector, filters, sort) */
  toolbar?: ReactNode
  /** Header actions (KPIs toggle, export dropdown) */
  headerActions?: ReactNode
  showGlobalNav?: boolean
}

export function DeploymentMobileHeader({
  searchValue,
  onSearchChange,
  stats,
  toolbar,
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10 px-3 pt-3 pb-4 space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-base font-semibold text-white truncate">Déploiement</h1>
              <p className="text-[10px] text-white/60 truncate">
                {stats.displayed} affich. • {stats.healthy} OK • {stats.avgProgress}%
              </p>
            </div>
          </div>
        ...
        {/* Row 2: Toolbar (view selector, filters, sort) */}
        {toolbar && (
