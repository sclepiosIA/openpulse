...
import { useCreateTachePartenaire } from "@/hooks/tasks/useTachesPartenaire"
import { useProfiles } from "@/hooks/profile/useProfiles"
import { useCategories } from "@/hooks/catalogue/useCategories"
import { useToast } from "@/hooks/shared/use-toast"

interface CreateTachePartenaireDialogProps {
  partenaireId: string
  triggerButton?: React.ReactNode
}

export function CreateTachePartenaireDialog({ partenaireId, triggerButton }: CreateTachePartenaireDialogProps) {
  ...
  const createTache = useCreateTachePartenaire()
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Créer une nouvelle tâche partenaire</DialogTitle>
        </DialogHeader>
