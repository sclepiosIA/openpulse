...
interface RapportsMobileHeaderProps {
  stats: {
...
export function RapportsMobileHeader({
  stats,
  onSearchClick,
  toolbar,
  headerActions,
  showGlobalNav = true,
}: RapportsMobileHeaderProps) {
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-base font-semibold text-white truncate">Rapports</h1>
              <p className="text-[10px] text-white/60 truncate">
                {stats.etablissements} étab. • CA {stats.caTotal}
              </p>
            </div>
          </div>
