...
import { Settings, Menu, Search, FileText } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { useMobileDrawer } from '@/contexts/MobileDrawerContext'

interface ParametresMobileHeaderProps {
  isAdmin: boolean
  onSearchClick: () => void
  onLogsClick: () => void
  toolbar?: ReactNode
...
export function ParametresMobileHeader({
  isAdmin,
  onSearchClick,
  onLogsClick,
  toolbar,
  showGlobalNav = true,
}: ParametresMobileHeaderProps) {
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-base font-semibold text-white truncate">Paramètres</h1>
              <p className="text-[10px] text-white/60 truncate">
                Configuration {isAdmin && '• Admin'}
              </p>
            </div>
          </div>
