...
interface TresorerieTabsCompactProps {
  activeTab: string
...
const tabs: TabItem[] = [
  ...
  { id: 'revenus', label: 'Revenus', icon: ArrowUpRight, color: 'text-emerald-400' },
  {
    id: 'depenses',
    label: 'Dépenses',
    icon: ArrowDownRight,
    color: 'text-red-400',
    badgeKey: 'depensesRetard',
  },
  {
    id: 'budgets',
    label: 'Budgets',
  ...
  },
  {
    ...
    badgeKey: 'qontoNonRapproches',
  },
  { id: 'categories', label: 'Catégories', icon: Tags },
  { id: 'previsionnel', label: 'Prévisionnel', icon: LineChart },
]

export function TresorerieTabsCompact({
  activeTab,
  onTabChange,
  badges = {},
}: TresorerieTabsCompactProps) {
  return (
